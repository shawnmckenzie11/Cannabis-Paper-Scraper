...
- Batch ID: `node1_calibration_20260618_181046_513`
- Created: `2026-06-18T18:12:33.097262`
- Rules version: `2.3.0`
...
- Updates applied: `20`
- Estimated API cost: `$0.2075`

## Variant Allocation

- `control`: 10 papers, 10 updates, avg confidence 0.845, cost $0.1031
- `decision_checklist`: 10 papers, 10 updates, avg confidence 0.867, cost $0.1045

## Most Changed Fields

- `exposure_method`: 20 changed papers
- `outcome_domain`: 14 changed papers
- `cannabis_type`: 7 changed papers
