...
def reingest_heuristic_papers(
    ...
    Args:
        ...
        max_papers: Optional cap on the number of selected papers for safe batches.
    ...
    if max_papers is not None and max_papers <= 0:
        raise ValueError("max_papers must be greater than zero when provided")
...
def main():
    ...
    parser.add_argument(
        ...
        type=int,
        default=None,
        help="Maximum number of selected papers to process in this run.",
    )
