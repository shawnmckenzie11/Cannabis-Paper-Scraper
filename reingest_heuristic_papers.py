...
def reingest_heuristic_papers(
    ...
    Args:
        ...
        max_papers: Optional hard cap on the number of selected papers.
    ...
    if max_papers is not None and max_papers <= 0:
        raise ValueError("max_papers must be greater than zero")
...
def main():
    ...
    parser.add_argument(
        ...
        type=int,
        default=None,
        help="Hard cap on selected papers for safe production batches.",
    )
